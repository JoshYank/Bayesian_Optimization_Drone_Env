...
for r in rand_num:
    ...
    Test=BO_CMAES(spec=pred3,boundary=bounds,budget=300,population_size=20,jump_con=10)
    Test.initialize()
    Test.run_BO_CMA()
    ...
    Test=BO_CMAES(spec=pred3,boundary=bounds,budget=400,population_size=20,jump_con=10)
    Test.initialize()
    Test.run_BO_CMA()
    Test.get_violation_count()
    BCMA_Counter.append(Test.Violation_Count)
    ...
    Test=BO_CMAES(spec=pred3,boundary=bounds,budget=500,population_size=20,jump_con=10)
    Test.initialize()
    Test.run_BO_CMA()
    Test.get_violation_count()
    BCMA_Counter.append(Test.Violation_Count)
