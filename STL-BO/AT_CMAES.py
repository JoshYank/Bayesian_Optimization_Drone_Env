    ...
    for r in C[a]:
        ...
        while True:
            ...
            for _ in range(optimizer.population_size):
                ...
                print(
                    f"{optimizer.generation:3d}  {value1} (x1={x[0]}, x2 = {x[1]},x3 = {x[2]},x4 = {x[3]})"
                )
